...
return function(inst)
    ...
    ---- 每个等级对应的函数
        local fns_by_level = {
            ...
            --- 
                [1] = function(inst)
                    inst.components.combat.externaldamagetakenmultipliers:SetModifier(level_modifer_inst, 1-0.55)
            ...
            --- 
                [2] = function(inst)
                    inst.components.combat.externaldamagetakenmultipliers:SetModifier(level_modifer_inst, 1-0.65)
            ...
            --- 
                [3] = function(inst)
                    inst.components.combat.externaldamagetakenmultipliers:SetModifier(level_modifer_inst, 1-0.75)
            ...
            --- 
                [4] = function(inst)
                    inst.components.combat.externaldamagetakenmultipliers:SetModifier(level_modifer_inst, 1-0.85)
