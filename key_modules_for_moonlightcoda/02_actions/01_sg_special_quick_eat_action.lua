...
AddStategraphState("wilson",State{
    name = "moonlightcoda_special_quick_eat",
    ...
    onenter = function(inst)
        ...
        inst.SoundEmitter:PlaySound("dontstarve/wilson/eat", "moonlightcoda_special_quick_eat")
    ...
    timeline =
        {
			...
			TimeEvent(60 * FRAMES, function(inst)
                inst.SoundEmitter:KillSound("moonlightcoda_special_quick_eat")
                inst:PerformBufferedAction()
...
AddStategraphState("wilson_client",State{
    name = "moonlightcoda_special_quick_eat",
    tags = { "doing", "busy", "canrotate","nointerrupt" },
    server_states = { "moonlightcoda_special_quick_eat" },
