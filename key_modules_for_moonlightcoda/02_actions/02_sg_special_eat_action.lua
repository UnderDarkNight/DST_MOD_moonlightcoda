...
AddStategraphState("wilson",State{
    name = "moonlightcoda_special_eat",
    ...
    onenter = function(inst)
        ...
        inst.SoundEmitter:PlaySound("dontstarve/wilson/eat", "moonlightcoda_special_eat")
    ...
    timeline =
        {
			...
			TimeEvent(130 * FRAMES, function(inst)
                inst.SoundEmitter:KillSound("moonlightcoda_special_eat")
                inst:PerformBufferedAction()
...
AddStategraphState("wilson_client",State{
    name = "moonlightcoda_special_eat",
    tags = { "doing", "busy", "canrotate","nointerrupt"},
    server_states = { "moonlightcoda_special_eat" },
